    ...
    <div className="min-h-screen bg-slate-100 text-black font-serif">
      ...
      <div className="max-w-[8.5in] mx-auto bg-white p-[1in] shadow-2xl mt-20 print:mt-0 print:shadow-none print:w-full">
        ...
        <section className="mb-12 page-break-inside-avoid">
          ...
          <div className="mb-8 p-6 border border-gray-300 rounded-lg bg-gray-50 print-bg-force">
          ...
          <div className="mb-6">
            ...
            <table className="w-full text-sm border-collapse border border-gray-300 mt-2">
              <thead>
                <tr className="bg-gray-100 print-bg-force">
                  ...
                  <th className="border border-gray-300 p-2 text-left">Gap / Weakness</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="border border-gray-300 p-2 font-bold">MyFitnessPal</td>
                  <td className="border border-gray-300 p-2">$19.99/mo</td>
                  <td className="border border-gray-300 p-2">Calorie Tracking</td>
                  <td className="border border-gray-300 p-2 italic text-gray-600">Manual entry is tedious.</td>
                </tr>
                <tr>
                  <td className="border border-gray-300 p-2 font-bold">Noom</td>
                  <td className="border border-gray-300 p-2">~$59.00/mo</td>
                  <td className="border border-gray-300 p-2">Weight Loss Psych</td>
                  <td className="border border-gray-300 p-2 italic text-gray-600">Expensive; high churn.</td>
                </tr>
                <tr>
                  <td className="border border-gray-300 p-2 font-bold">Whoop</td>
                  <td className="border border-gray-300 p-2">~$30.00/mo</td>
                  <td className="border border-gray-300 p-2">Hardware Recovery</td>
                  <td className="border border-gray-300 p-2 italic text-gray-600">Requires expensive hardware.</td>
                </tr>
                <tr className="bg-emerald-100 print-bg-force">
                  <td className="border border-emerald-300 p-2 font-bold text-black">Vitalis AI</td>
                  <td className="border border-emerald-300 p-2 font-bold text-emerald-900">$14.99/mo</td>
                  <td className="border border-emerald-300 p-2 font-bold text-emerald-900">Holistic AI Coach</td>
                  <td className="border border-emerald-300 p-2 font-bold text-emerald-900">Combines Fitness & Recovery.</td>
                </tr>
              </tbody>
            </table>
          </div>
             ...
             <div>
               ...
               <div className="flex gap-4">
                  <div className="text-center">
                    <div className="w-12 h-12 bg-emerald-500 mb-1 border border-gray-200 print-bg-force"></div>
                    <span className="text-xs">Emerald</span>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 bg-slate-900 mb-1 border border-gray-200 print-bg-force"></div>
          ...
          <table className="w-full text-xs border-collapse border border-gray-300">
            <thead>
               <tr className="bg-gray-100 print-bg-force">
                 ...
                 <th className="border border-gray-300 p-1 text-left">Dates</th>
                 <th className="border border-gray-300 p-1 text-left">Dur.</th>
               </tr>
            </thead>
            <tbody>
              {GANTT_DATA.map((item, idx) => (
                <tr key={idx}>
                  <td className="border border-gray-300 p-1">{item.phase}</td>
                  <td className="border border-gray-300 p-1">{item.task}</td>
                  <td className="border border-gray-300 p-1">{new Date(item.start).toLocaleDateString()} - {new Date(item.end).toLocaleDateString()}</td>
                  <td className="border border-gray-300 p-1">{item.duration} days</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <section className="mb-12">
          ...
          <table className="w-full text-sm border-collapse border border-gray-300 mb-6">
            ...
            <tbody>
              ...
              <tr className="bg-gray-50 print-bg-force">
          ...
          <div className="bg-gray-50 p-6 border border-gray-200 rounded print-bg-force">
